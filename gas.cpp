...
CommandTemporaryAllocator::CommandTemporaryAllocator(
...
FrontendCommands * CommandTemporaryAllocator::getNewCommandBlock()
{
...
void CommandTemporaryAllocator::destroy()
{
